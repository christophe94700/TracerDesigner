...
// Ajouter une fonction pour ouvrir l'iframe A propos
openAbout() {
    const iframe = document.createElement('iframe');
    iframe.src = './iframe/about.html';
    ...
    // Ajouter un bouton pour fermer l'iframe
  ...
  init () {
    ...
    template.innerHTML = `
    <se-menu id="main_button" label="Designer" src="logo.svg" alt="logo">
        ...
        <p hidden><se-menu-item id="tool_editor_homepage" label="tools.editor_homepage" src="logo.svg"></se-menu-item></p>
        <se-menu-item id="tool_open_about" label="A Propos" src="apropos.svg"></se-menu-item>'
	</se-menu>`
	...
	$id('tool_open_about').addEventListener(
      'click',
