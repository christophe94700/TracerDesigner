export default {
  ...
  ui: {
    ...
    quality: 'Qualité:',
    pathNodeTooltip: 'Faites glisser le nœud pour le déplacer. Double-cliquez sur le nœud pour changer le type de segment',
    pathCtrlPtTooltip: 'Faites glisser le point de contrôle pour ajuster les propriétés de la courbe',
    pick_stroke_paint_opacity: 'Choisissez une couleur de contour et une opacité',
    pick_fill_paint_opacity: 'Choisissez une couleur de remplissage et une opacité',
    group_identify_label: 'Étiquette pour identifier le groupe',
    export_type_label: 'Sélectionnez un type à exporter :'
  },
  properties: {
